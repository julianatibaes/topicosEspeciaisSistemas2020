 ...
 * @author Juliana
 * 
 *         O JwtRequestFilter estende a classe Spring Web Filter
 *         OncePerRequestFilter. Para qualquer solicitação recebida, esta classe
 *         Filter é executada. Ele verifica se a solicitação possui um token JWT
 *         válido. Se ele tiver um token JWT válido, ele definirá a autenticação
 *         no contexto, para especificar que o usuário atual será autenticado.
 *
 */
